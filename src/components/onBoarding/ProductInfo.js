...
class ProductInfo extends Component {
    ...
    saveFollowedProductsData = () => {
        ...
        return Promise.all(handleExistingProductsTasks.concat(handleNewProductsTasks))
            .then(() => axios.post(`${BASE_URL}/api/v1/user/onboarding`, { completed: true }, { withCredentials: true }))
            .then(res => {
                this.setState({
                    buttonLoading: false
                });
                this.props.history.push('/networkFeed/global/noop');
            })
            .catch(err => {
                console.log(err);
                this.setState({
                ...
                <Grid.Row className="background-white extra-padding-sides">
                    ...
                    <Grid.Column width={16}>
                        ...
                        <Button
                            ...
                            type='button'
                            onClick={e => this.saveFollowedProductsData()}
                            floated='right'
                            size='mini'
                            color='blue'
                        >
