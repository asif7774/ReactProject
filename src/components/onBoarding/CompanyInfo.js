...
import { Grid, Form, Button, Divider, Select, Search, Label, Message } from 'semantic-ui-react';
...
class CompanyInfo extends Component {
    ...
    addCompany() {
        ...
        if(!data.name){
            this.showMessage("Company name is mandatory", false);
            return;
        }
        if(!data.country){
            this.showMessage("Country is mandatory", false);
            return;
        }
                ...
                <Grid.Row className="background-white extra-padding-sides">
                    ...
                    <Grid.Column width={12} className="mT-10">
                        <Form stackable={'true'} className="custom-input-form">
                            ...
                            <Form.Group widths={2}>
                                <Form.Field>
                                    <Form.Input onChange={this.handleAddressChange.bind(this)} value={this.state.address} label='ADDRESS' />
                                </Form.Field>
                                <Form.Field className="required">
                                    <Form.Input onChange={this.handleCountryChange.bind(this)} value={this.state.country} label='COMPANY LOCATION' />
                                </Form.Field>
                            </Form.Group>
                            <Form.Group widths={2}>
                                <Form.Field>
                                ...
                                <Form.Field>
                                    <Form.Field control={Select} label='COMPANY TYPE' options={options} placeholder='' />
                                </Form.Field>
                            </Form.Group>
                            <Form.Group widths={1}>
                                <Form.Field
