...
export default class AddRaw extends Component {
    constructor(props) {
        super(props);
        this.state = {
            user: null
        ...
        return (
            <Feed.Event>
                ...
                <Feed.Content>
                    ...
                    <Feed.Summary>
                        {this.props.item.user_name} added {this.props.item.otherProductName} as raw material of {this.props.item.product_name}
                    </Feed.Summary>
                    <Divider />
                </Feed.Content>
            </Feed.Event>
